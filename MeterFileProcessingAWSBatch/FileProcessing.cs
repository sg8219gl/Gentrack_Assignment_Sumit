...
namespace MyApp
{
    public class FileProcessing : Stack
    {
        public FileProcessing(Construct scope, string id, IStackProps props) : base(scope, id, props)
        {
            ...
            dynamo.Table table =new dynamo.Table(this, Constants.DynamoDB_TABLE_ID, new dynamo.TableProps{
                ...
                PartitionKey = new dynamo.Attribute { Name = "Meter", Type = dynamo.AttributeType.STRING },
